    ...
    <nav className="navigationBarBox">
      ...
      <div className="interfaceOptionsBox">
        ...
        <div className="interfaceLanguageBox">
          <div
            className={"f4 f3-ns link dim black-60 pa2 pa3-ns ma0 pointer interfaceLanguageEnglish".concat(
          ...
          <div
            className={"f4 f3-ns link dim black-60 pa2 pa3-ns ma0 pointer interfaceLanguageArmenian".concat(
